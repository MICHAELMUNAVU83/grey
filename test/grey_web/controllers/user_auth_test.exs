defmodule GreyWeb.UserAuthTest do
  use GreyWeb.ConnCase

  alias Grey.Users
  alias GreyWeb.UserAuth
  import Grey.UsersFixtures

  @remember_me_cookie "_grey_web_user_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, GreyWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      GreyWeb.Endpoint.subscribe(live_socket_id)
